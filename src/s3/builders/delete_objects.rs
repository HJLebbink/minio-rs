...
///
/// This struct constructs the parameters required for the [`Client::remove_object`](crate::s3::client::MinioClient::delete_object) method.
...
///
/// This struct constructs the parameters required for the [`Client::`](crate::s3::client::MinioClient::get_bucket_encryption) method.
